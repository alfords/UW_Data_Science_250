...
naiveBayesModel <- naiveBayes(formula, data=trainSet) # Made change here
# Predict the outcomes for the test data
predictedProbabilities.NB <- predict(naiveBayesModel, newdata=testSet, type="raw") # Made change here
###################################################
...
# convert the predicted probabilities to predictions
predicted.NB <- as.numeric(predictedProbabilities.NB[,2] > threshold) # Made change here
print(" ")
print(" -------------------------------- ")
print("Confusion Matrix Naive Bayes")
# create a table to compare predicted values to actual values
print(table(predicted.NB, testSet$Severity)) # Made change here
###################################################
